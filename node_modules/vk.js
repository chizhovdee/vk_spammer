...
*  http://vk.com/api_updates Здесь лог изменений в api, ЕСЛИ ЧТО НЕ РАБОТАЕТ ДУЙ СЮДА
*
*/
...
var scope = 'friends,groups,offline';
...
module.exports.authorize = function (login, pass, callback) {
  ...
  authUrl += "&redirect_uri=http://oauth.vk.com/blank.html&response_type=token&v=5.9";
